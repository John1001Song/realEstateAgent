<?php include 'shared/header.php';?>
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>High Quality Properties</span></h2>
          <div class="clr"></div>
          <p>近期上市房产</p>
            <ul class="qualified-property-list">
                <li class="property-in-list">
                    <div class="property-photo-list">
                    ...
                    <div class="property-list-description">
                        ...
                        此单元是在32层的，三房三卫，明亮通透，饱览湖景和市区景观，举步联合地铁站，市中心金融街，湖滨，地下商城，冰球名人馆，BCE购物广场，Sony剧院，Rogers Center, CN Tower，水族馆，加航中心, 多伦多会议中心，地铁，高速等。</p>
                    </div>
                </li>  
            </ul>  
          
            
<!--          <p>更多房产请联系<a>Huang Jing</a></p>-->
        </div>
      </div>
